...
export async function GET(request) {
  ...
  if (fileName === "") {
    try {
      ...
      const allData = await DataSP.find({}).lean(); // Using `.lean()` for better performance if you don’t need Mongoose documents
    ...
    try {
      ...
      const combinedResults = await DataSP.aggregate([
